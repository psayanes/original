...
const ORDER_BY_PROD_COST = "Valor";
...
function showProductsList(array){
    ...
    for(let i = 0; i < currentProductsArray.length; i++){
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="d-flex w-100 justify-content-between">
                            ...
                            <h6 class="mb-1">Valor ` + product.currency + ` ` + product.cost + `</h6> <small class="text-muted">Vendidos: ` + product.soldCount + `</small>
                        </div>
        ...
        document.getElementById("show-products-list").innerHTML = htmlContentToAppend;
    }
...
document.addEventListener("DOMContentLoaded", function(e){
    ...
    document.getElementById("rangeFilterCost").addEventListener("click", function(){
        ...
        //de productos de acuerdso al valor
